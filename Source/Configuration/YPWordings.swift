...
public struct YPWordings {
    ...
    public var warningMaxVideoItemsLimit = ypLocalized("YPImagePickerWarningItemsVideoLimit")
    public var warningMaxImageItemsLimit = ypLocalized("YPImagePickerWarningItemsImageLimit") 
