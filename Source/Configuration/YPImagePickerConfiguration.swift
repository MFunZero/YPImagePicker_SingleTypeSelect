...
public struct YPConfigLibrary {
    ...
    /// Only support multiple selection button.
    public var onlyMultipleSelection = false
    
    /// Only one Type selected
    public var singleMediaMultipleSelection = false
    ...
    /// Video-Anything superior than 1 will enable the multiple selection feature.
    public var maxNumberOfVideo = 1
    
    /// Image-Anything superior than 1 will enable the multiple selection feature.
    public var maxNumberOfImage = 1
